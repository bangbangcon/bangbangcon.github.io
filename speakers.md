...
**_"Gik! A universal user interface! for interactive fiction!"_**

In 1997, I set out to extend Infocom's Z-machine to support modern interactive fiction. Surprisingly, many of my design decisions turned out to be clever! Blok is now a thriving software ecosystem which supports many IF platforms, interpreters, and other tools. It's also hard to pronounce [ANON: original name].
