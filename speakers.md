...
**Andrew** is a Web-focused programmer with a background in security. He's got opinions about copyright law, federated services, and homomorphic encryption.
...
We've all played games that don't feel quite right. Sometimes they seem too floaty, sometimes we get hit even when we could have sworn we pressed that dodge button in time, and sometimes there just isn't that OOMPH that we're looking for. "Game feel" refers to how well a game's visuals, audio, design, and mechanics line up with how our brains think they "should" feel. And oftentimes, developing a game with "good game feel" ends up boiling down to crunchy sounds, tight controls, and excessive screen shake.

But in this talk we'll be going even further--let's explore the unknown reaches of game feel together! You think zero-latency inputs feel tight? How about ~negative~ latency? Let's talk about all the weird things we can do in the name of improving game feel, even to the point of breaking our own games if it means matching our brains' silly expectations about how the world should work.
...
**How I F—'d Myself With Go!**

Installing an after-market vagina makes your body go all "oh noes theres a huge gash here I better close it asap!!" To avoid that happening, we use dilators. They're used on the vaginal canal to, well, y'know, dilate it. And if your healing rate is particularly good, missing even a single day may be catastrophic.

Dilators are phallic, like a dildo, but completely smooth and made to specific measurements. They're medical devices, not sex toys, which doesn't really matter depending on what kind of airport security you run into. Sometimes security decides random things aren't allowed on-board, and confiscate and throw away whatever they want.

So if I take my dilators as carry-on, they might get confiscated; if I dispatch them, the bags might get lost. Given that I can't miss a single day, and that I travel a lot... it's a scary scenario.

The solution: A platform that makes it easy for any trans person to generate 3D models of their dilators. This way we can either have them printed online at the city we're going to beforehand, and shipped to the hotel. Or, in case we get a bad draw in airport lottery, we have the option to run to a hackerspace and print new ones right then and there.
...
Inspired by the paper "Determining the Geographical Location of Image Scenes Based on Object Shadow Lengths" by "Frode Eika Sandnes", I am making a request for the proposal to talk about geolocation calculation from object shadows. This method needs a simple setup and uses a mathematical algorithm to compute the geolocation where an experiment is being performed.

Through this talk, I will share my experience making a set up for an experiment just by using cardboard, a refill, and 2-megapixel camera. We will also see some snippets of code written in C and Matlab to do some computations along with some cool plots and images. Finally, we will touch upon some of the things that should be considered in order to get accurate results. 

I worked on this project during my masters and was valuable towards extending my knowledge after collaborating with Prof. Sandnes himself.

**Jayesh Kawli** has been writing iOS applications for more than 5 years. Currently, he is working at Wayfair in Boston as an iOS developer and currently acts as a tech lead for the cart and checkout team. His team is responsible for handling cart and payments system in the Wayfair iOS application.
...
**Melody** is a web developer and community event organizer based in Philly. They spend most of their days making art, websites, and tea!
...
**We Love Polyhedra! (And You Should Too!)**
...
**Omar** loves telling stories, whether that's through making web games, writing or teaching. He loves making things that are accessible and can be enjoyed by all. You can check out all his stuff on his [personal website](http://omarshehata.me/).
...
Hip musicians are releasing their work on vinyl these days. Hipper artists release on cassette tape. Is it possible to be even more hip?

A few months ago, I helped a friend release their latest album as a playable Nintendo Game Boy game!

I'll go over the adventures of putting this project together, from designing and building hardware for full-quality audio playback, writing assembly code for two architectures, reverse engineering an existing game, and gluing it all together with code in Python, C, and Make.

**Peter** is a software engineer, musician, and hacker from Toronto, currently living in Brooklyn. His business cards say "House Drummer at Spotify" but his manager keeps reminding him he gets paid to help make Discover Weekly better.
...
Join us as we unearth some of this comedy! Live from New York, it's Saturday Night Bang Bang Con!!!

**Pranshu Bajpai** is a security researcher working towards his PhD in Computer Science and Engineering at Michigan State University. His research interests lie in computer and network security, malware analysis, digital forensics, and cyber crimes. In the past, he worked as a penetration tester. He has authored several papers in security magazines and journals and has served as a technical reviewer for books within the security domain. He has been an active speaker at industry and academic conferences and spoken at DEF CON, IEEE APWG eCrime conference, GrrCon, ToorCon, CascadiaJS, BSides and others. He holds an MS in Information Security and an MBA in Marketing. 
...
**All about that Base!! A Data Discovery Story!!**

Have you ever had to learn a new tool at work only to find it has become your new addiction? That happened to me with Airtable. One minute I was reluctantly creating an account and grousing about why we needed another spreadsheet option - and the next minute I was madly searching for data and use cases to flex my newfound knowledge on!! In the process, I rediscovered a fundamental truth about product design. That the best designs are not those that simplify what is, but that spark the imagination for what could be.

This is my story of how I went from simply being productive at work to creating reusable processes for communities and rediscovering my culture. And it's all about that Base!

**Nitya Narasimhan** is a PhD, Polyglot, Parent and Procrastinator with over 20 years experience in software design, development and research. Her ambition is to index all the events and characters of the great Indian epics, and bring those stories to life in new ways for a modern generation of kids.
...
**Tessa** spends a lot of time trying to make robots do biology experiments. She also likes impractical circuits, elaborate costume parties, fretting about biosecurity, organizing effective altruist events, and irritating her coworkers by spelling 'behaviour' with a 'u'.
...
**Vaibha**v used to restart failed build pipelines. He still does, but he used to, too. When he's not doing that, he enjoys re-racking his weights and pointing bright lights at just the right spot on his disco ball for maximum sparkles.
...
Perhaps you would be interested in our [2018](2018/speakers.html), [2017](2017/speakers.html), [2016](2016/speakers.html), [2015](2015/speakers.html), or [2014](2014/speakers.html) speakers?
